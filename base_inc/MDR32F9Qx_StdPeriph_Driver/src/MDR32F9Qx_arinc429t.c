...
/**
  ...
  * @retval	None
  */
void ARINC429T_ChannelInit(uint32_t ARINC429T_CHANNELx, ARINC429T_InitChannelTypeDef * ARINC429T_InitChannelStruct)
{
	MDR_ARINC429T_TypeDef * ARINC429Tx;
	uint32_t tmpreg_CONTROL1;
    ...
    tmpreg_CONTROL4 |= ARINC429T_InitChannelStruct->ARINC429T_ENSYNC << ARINC429T_CHANNELx;
    ARINC429Tx->CONTROL4 = tmpreg_CONTROL4;

#if defined ( USE_MDR1986VE3 )
    tmpreg_CONTROL5 = ARINC429Tx->CONTROL5;
    tmpreg_CONTROL5 &= ~(0xFF << (ARINC429T_CHANNELx*8));
    tmpreg_CONTROL5 |= (ARINC429T_InitChannelStruct->ARINC429T_PAUSE << (ARINC429T_CHANNELx*8));
    ARINC429Tx->CONTROL5 = tmpreg_CONTROL5;
#endif /* #if defined ( USE_MDR1986VE3 ) */
