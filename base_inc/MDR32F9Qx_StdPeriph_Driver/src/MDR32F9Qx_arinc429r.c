...
void ARINC429R_DeInit()
{
	...
	ARINC429Rx->LABEL	 = 0;
    ARINC429Rx->CONTROL8 = 0;
    ARINC429Rx->CONTROL9 = 0;
#if defined (USE_MDR1986VE3)
	ARINC429Rx->CONTROL6 = 0;
	ARINC429Rx->CONTROL7 = 0;
    ARINC429Rx->CONTROL10 = 0;
    ARINC429Rx->CONTROL11 = 0;
    ARINC429Rx->CONTROL12 = 0;
    ARINC429Rx->CONTROL13 = 0;
...
void ARINC429R_ChannelInit(uint32_t ARINC429R_CHANNELx, ARINC429R_InitChannelTypeDef * ARINC429R_InitChannelStruct)
{
    ...
    uint32_t tmpreg_CONTROL8;
    uint32_t tmpreg_CONTROL9;
#if defined (USE_MDR1986VE3)
	uint32_t tmpreg_CONTROL6;
	uint32_t tmpreg_CONTROL7;
    uint32_t tmpreg_CONTROL10;
    uint32_t tmpreg_CONTROL11;
    uint32_t tmpreg_CONTROL12;
    uint32_t tmpreg_CONTROL13;
#endif
    ...
    /* Разрешение 32 бита паритета ENPAR и выбор четности/нечетности бита паритета ODD */
    tmpreg_CONTROL8 = ARINC429Rx->CONTROL8;
    tmpreg_CONTROL8 &= ~((1<<(ARINC429R_CONTROL8_ENPAR1_Pos + ARINC429R_CHANNELx))\
                        |(1<<(ARINC429R_CONTROL8_ODD1_Pos + ARINC429R_CHANNELx)));
    tmpreg_CONTROL8 |= ((ARINC429R_InitChannelStruct->ARINC429R_ENPAR << (ARINC429R_CONTROL8_ENPAR1_Pos + ARINC429R_CHANNELx))\
                       |(ARINC429R_InitChannelStruct->ARINC429R_ODD << (ARINC429R_CONTROL8_ODD1_Pos + ARINC429R_CHANNELx)));
    ARINC429Rx->CONTROL8 = tmpreg_CONTROL8;

    /* Разрешение работы входов приемника в режиме данных и синхросигнала */
...
#if defined (USE_MDR1986VE3)
    /* Set pause between message channel ARINC429R_CHANNELx */
    switch (ARINC429R_CHANNELx){
        case ARINC429R_CHANNEL1:
        case ARINC429R_CHANNEL2:
        case ARINC429R_CHANNEL3:
        case ARINC429R_CHANNEL4:
            tmpreg_CONTROL10 = ARINC429Rx->CONTROL10;
            tmpreg_CONTROL10 &= ~(0xFF<<(ARINC429R_CHANNELx*8));
            tmpreg_CONTROL10 |= ARINC429R_InitChannelStruct->ARINC429R_PAUSE << (ARINC429R_CHANNELx*8);
            ARINC429Rx->CONTROL10 = tmpreg_CONTROL10;
            break;
        case ARINC429R_CHANNEL5:
        case ARINC429R_CHANNEL6:
        case ARINC429R_CHANNEL7:
        case ARINC429R_CHANNEL8:
            tmpreg_CONTROL11 = ARINC429Rx->CONTROL11;
            tmpreg_CONTROL11 &= ~(0xFF<<((ARINC429R_CHANNELx - ARINC429R_CHANNEL5)*8));
            tmpreg_CONTROL11 |= ARINC429R_InitChannelStruct->ARINC429R_PAUSE << ((ARINC429R_CHANNELx - ARINC429R_CHANNEL5)*8);
            ARINC429Rx->CONTROL11 = tmpreg_CONTROL11;
            break;
        case ARINC429R_CHANNEL9:
        case ARINC429R_CHANNEL10:
        case ARINC429R_CHANNEL11:
        case ARINC429R_CHANNEL12:
            tmpreg_CONTROL12 = ARINC429Rx->CONTROL12;
            tmpreg_CONTROL12 &= ~(0xFF<<((ARINC429R_CHANNELx - ARINC429R_CHANNEL9)*8));
            tmpreg_CONTROL12 |= ARINC429R_InitChannelStruct->ARINC429R_PAUSE << ((ARINC429R_CHANNELx - ARINC429R_CHANNEL9)*8);
            ARINC429Rx->CONTROL12 = tmpreg_CONTROL12;
            break;
        case ARINC429R_CHANNEL13:
        case ARINC429R_CHANNEL14:
            tmpreg_CONTROL13 = ARINC429Rx->CONTROL13;
            tmpreg_CONTROL13 &= ~(0xFF<<((ARINC429R_CHANNELx - ARINC429R_CHANNEL13)*8));
            tmpreg_CONTROL13 |= ARINC429R_InitChannelStruct->ARINC429R_PAUSE << ((ARINC429R_CHANNELx - ARINC429R_CHANNEL13)*8);
            ARINC429Rx->CONTROL13 = tmpreg_CONTROL13;
            break;
    }
#endif
}
