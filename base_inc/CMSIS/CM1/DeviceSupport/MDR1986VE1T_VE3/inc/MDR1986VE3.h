...
/*----- 1986EV3 specific Interrupt Numbers -------------------------------------------------------*/
  ...
  ARINC429T_IRQn              = 21,     /*!< ARINC429 Transmitter 1 Interrupt                     *///!< ARINC429T_IRQn
  KEYBOARD_IRQn               = 22,     /*!< Keyboard Interrupt                                   *///!< KEYBOARD_IRQn
  LED_IRQn                    = 23,     /*!< Display Interrupt                                    *///!< LED_IRQn
  UART3_UART4_IRQn            = 24,     /*!< UART3 and UART4 Interrupt                            *///!< UART3_UART4_IRQn
  AUDIO_IP_IRQn               = 25,     /*!< AudioCodec Interrupt                                 *///!< AUDIO_IP_IRQn
  ETHERNET2_IRQn              = 26,     /*!< Ethernet2 Interrupt                                  *///!< ETHERNET2_IRQn
...
/** @defgroup __VE3_Periph_ARINC429R_CONTROL3  ARINC429R CONTROL3
  * @{
  */
...
/* Bit field positions: */
#define ARINC429R_CONTROL7_DIV_CH13_Pos              0
#define ARINC429R_CONTROL7_DIV_CH14_Pos              8
...
/** @defgroup __VE3_Periph_ARINC429T_STATUS  ARINC429T STATUS
  * @{
  */
